...
Every scaffolded application includes a `crossplane/` directory for hosting **app-specific** Crossplane Composite Resource Definitions (XRDs) and Compositions.
...
You scaffold a Keycloak application using the Hiroba template. The `crossplane/` directory starts empty. Your team then adds:
